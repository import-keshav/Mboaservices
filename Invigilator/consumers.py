...
class ClientToInvigilator(WebsocketConsumer):
    def connect(self):
...
class ClientsToInvigilator(WebsocketConsumer):
    def connect(self):
        self.room_name = self.scope['url_route']['kwargs']['room_name']
        self.person = self.scope['url_route']['kwargs']['person']
        self.room_group_name = 'chat_%s' % self.room_name
