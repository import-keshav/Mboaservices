...
class Restaurant extends Component {
    render() {
        ...
        return (
            <div className="restaurant" onClick={() => { this.props.history.push(`/restaurant/${this.props.id}`) }}>
                <img src={this.props.src} className="image" alt="restaurant" />
                ...
                <div className="offers" style={{ display: "flex" }}>
