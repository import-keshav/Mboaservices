    ...
    render() {
        return (
            <div className="cart-it">
                ...
                <AddOnModal handleAdd={this.handleAdd} {...this.props} cartItemId={this.props.id} addOns={this.state.addOns} open={this.state.addOnVisible} onClose={this.handleClose} />
